...
if __name__ == "__main__":
    ...
    about = {}
    with open(os.path.join(src_dir, "vivarium_csu_alzheimers", "__about__.py")) as f:
        exec(f.read(), about)
    ...
    install_requirements = [
        ...
        "vivarium_public_health>=4.3.10,<5.0.0",
        "jinja2",
        "pyyaml",
    ]
    ...
    cluster_requirements = ["vivarium_cluster_tools>=2.1.20"]
    test_requirements = [
    ...
    setup(
        ...
        zip_safe=False,
        use_scm_version={
            "write_to": "src/vivarium_csu_alzheimers/_version.py",
