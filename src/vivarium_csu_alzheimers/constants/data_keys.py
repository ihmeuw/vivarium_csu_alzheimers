...
class __Alzheimers(NamedTuple):
    AD_AND_MIXED_DEMENTIA_PREVALENCE: str = "cause.alzheimers.dementia_prevalence"
    ...
    SEVERE_DEMENTIA_PREVALENCE: str = "sequela.severe_alzheimers_disease_and_other_dementias.prevalence"
    ...
    MILD_DEMENTIA_DISABILITY_WEIGHT: str = "sequela.mild_alzheimers_disease_and_other_dementias.disability_weight"
    MODERATE_DEMENTIA_DISABILITY_WEIGHT: str = "sequela.moderate_alzheimers_disease_and_other_dementias.disability_weight"
    SEVERE_DEMENTIA_DISABILITY_WEIGHT: str = "sequela.severe_alzheimers_disease_and_other_dementias.disability_weight"
...
class __AlzheimersConsistent(NamedTuple):
    AD_AND_MIXED_DEMENTIA_PREVALENCE: str = "cause.alzheimers_consistent.dementia_prevalence"
    ...
    MODERATE_DEMENTIA_CONDITIONAL_PREVALENCE: str = "cause.alzheimers_consistent.moderate_dementia_conditional_prevalence"
    SEVERE_DEMENTIA_CONDITIONAL_PREVALENCE: str = "cause.alzheimers_consistent.severe_dementia_conditional_prevalence"
